  ...
  if 'code' in form and 'py_v' in form:
    ...
    if py_v in ['3','2']:
      ...
      with open(fname1, 'w') as f:
        f.write(f'exec(__import__("base64").b64decode(__import__("sys").argv[1].decode()))')
      os.system(f'python{py_v} {fname1} {base64.b64encode(form["code"].encode()).decode()} 2> {fname2}')
      try:
